...
import { Mail, Lock, User, UserPlus, Fingerprint, Store, Eye, EyeOff } from 'lucide-react';
      ...
      <div className="relative w-full max-w-md animate-scale-in">
        <div className="mb-8 text-center">
          <div className="mx-auto mb-5 flex h-20 w-20 items-center justify-center rounded-2xl bg-gradient-to-br from-fif-500 to-fif-700 shadow-lg shadow-fif-500/25 ring-1 ring-white/10">
            <img src="/logobaru.png" alt="FIF" className="h-12 w-12 object-contain drop-shadow-lg" />
          </div>
        ...
        <div className="group relative">
          ...
          <div className="relative rounded-2xl border border-white/10 bg-white/[0.06] p-7 backdrop-blur-2xl dark:bg-slate-900/70">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input type={showPassword ? 'text' : 'password'} value={password} onChange={(e) => setPassword(e.target.value)} required minLength={8}
                    ...
                    className="w-full rounded-xl border border-white/10 bg-white/[0.04] py-2.5 pl-10 pr-10 text-sm text-white outline-none transition-all placeholder:text-slate-600 focus:border-fif-500/50 focus:bg-fif-500/5 focus:ring-2 focus:ring-fif-500/15"
            ...
            <p className="mt-6 text-center text-sm text-slate-600">
              Sudah punya akun?{' '}
              <Link href="/login" className="font-medium text-fif-400 transition-all hover:text-fif-300 hover:underline underline-offset-2">
                Masuk
              </Link>
            </p>
          </div>
