...
export default function RollingApprovalPage() {
  ...
  return (
    <div className="font-poppins space-y-6 animate-fade-in">
      <div>
        <h1 className="font-heading text-2xl font-bold tracking-tight text-slate-900 dark:text-white">Rolling Data Approval</h1>
        <p className="mt-1 text-sm font-medium text-slate-500 dark:text-slate-400">Approve atau reject request pinjam data antar marketing</p>
      </div>
