...
import { CalendarClock, Loader2, Plus, Pencil, Trash2, Bell, AlarmClock, UserRound, Clock, Bot, Sparkles } from 'lucide-react';
import { useAuth } from '@/context/AuthContext';
import { useToast } from '@/components/ui/Toast';
import { Modal } from '@/components/ui/Modal';
import { Input, Select } from '@/components/ui/Input';
import { scheduleService, type BroadcastSchedule, type NotifSettings } from '@/services/scheduleService';
...
export default function PengaturanPage() {
  ...
  const [activeTab, setActiveTab] = useState<'jadwal' | 'notifikasi' | 'autoreply' | 'ai'>('jadwal');
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm font-medium text-slate-500 dark:text-slate-400">
          Atur jadwal broadcast otomatis dan notifikasi WhatsApp
        </p>
      </div>
