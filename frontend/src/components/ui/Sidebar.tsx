...
const adminLinks: LinkItem[] = [
  ...
  { to: '/admin/broadcast-report', label: 'Laporan Broadcast', icon: <BarChart3 className="h-4.5 w-4.5" />,   feature: 'broadcast_stats',  section: 'main' },
...
const marketingLinks: LinkItem[] = [
  ...
  { to: '/marketing/broadcast-report', label: 'Laporan Broadcast', icon: <BarChart3 className="h-4.5 w-4.5" />,   feature: 'broadcast_stats',    section: 'main' },
