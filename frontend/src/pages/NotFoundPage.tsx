  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-6 bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 p-4 animate-fade-in">
      <div className="text-center relative">
        ...
        <h1 className="bg-gradient-to-br from-white to-white/20 bg-clip-text text-8xl font-extrabold tracking-tight text-transparent drop-shadow-sm">404</h1>
        <h2 className="-mt-4 text-2xl font-bold text-white drop-shadow-sm">Halaman Tidak Ditemukan</h2>
