    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-fif-900 via-fif-800 to-slate-900 p-4">
      ...
      <div className="relative w-full max-w-md animate-slide-up">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-8 backdrop-blur-xl">
          ...
          <Button variant="secondary" onClick={handleGoogle} className="w-full border-white/10 bg-white/5 text-slate-300 hover:bg-white/10">
          ...
          <p className="mt-6 text-center text-sm text-slate-500">
            Belum punya akun?{' '}
            <Link to="/register" className="font-medium text-fif-400 transition-colors hover:text-fif-300">
              Daftar
            </Link>
          </p>
        </div>
